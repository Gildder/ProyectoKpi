		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					{{-- Quitar Cargo --}}
					<a href="javascript:void(0)" data-toggle="modal" data-target="#modal-deleteCargos-{{$item->id}}" class="btn btn-danger btn-sm" ><span class="fa fa-trash"  title="Quitar Cargo"></span></a>
				</td>
