   ...
   <!-- Modal -->
<div class="modal fade modal-slide-in-right" aria-hidden="true" tabindex="-1" role="dialog" id="modal-deleteCargoSupervisor-{{ $item->codigo }}">
  <div class="modal-dialog">
    ...
    <div class="modal-delete-content modal-content ">
      ...
      <div class="modal-body modal-delete-body">
           {!!Form::open(['action'=>['Supervisores\SupervisorController@quitarcargo', $item->codigo, $lista->id], 'method'=>'GET'])!!}
