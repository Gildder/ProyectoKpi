...
<div class="panel panel-default">
  <div class="panel-heading">
      <strong><?php echo e($cargo->id); ?> - <?php echo e($cargo->nombre); ?></strong>
  </div>
  <div class="panel-body">

  <div class="col-lg-12 breadcrumb">
    <a  href="<?php echo e(route('empleados.cargo.index')); ?>" class="btn btn-primary btn-xs"><span class="fa fa-reply"></span></a>
  </div>
