	...
	<table id="myTable" class="table  table-striped table-bordered table-condensed table-hover">
		...
		<?php foreach($tareas as $tarea): ?>
			<tr>
				...
				<td><?php if($tarea->fechaInicioSolucion == ''): ?> _/_/_ <?php else: ?>  <?php echo e($tarea->cambiarFormatoEuropeo($tarea->fechaInicioEstimado)); ?>  <?php endif; ?></td>
				<td><?php if($tarea->fechaFinSolucion == ''): ?> _/_/_ <?php else: ?>  <?php echo e($tarea->cambiarFormatoEuropeo($tarea->fechaFinEstimado)); ?>  <?php endif; ?></td>
