...
<div class="panel panel-default">
  ...
  <div class="col-lg-12 breadcrumb">
    <a  href="{{route('tareas.tareaDiaria.index')}}" class="btn btn-primary btn-sm"><span class="fa fa-reply"></span></a>
      ...
      {!!Form::model($tarea, ['route'=>['tareas.tareaDiaria.storeResolver', $tarea->id], 'method'=>'PUT'])!!}
              ...
              <div class="row col-sm-12">
                <div class="col-sm-4">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      @include('tareas/tareaDiaria/partials/tabla_localizaciones')
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  ...
                  @include('tareas/tareaDiaria/partials/tabla_agregados')
                </div>
              </div>
            ...
            <div class="modal-footer modal-delete-footer">
              <a  id="cancelar" href="{{route('tareas.tareaDiaria.show', $tarea->id)}}"  class="btn btn-danger" ><span class="fa fa-times"></span> Cancelar</a>
