...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="row">
      <div class="col-lg-12">
          <div class="col-sm-12 form-group" ><small>Semana {{$semanas[0]['semana']}} del mes de {{nombreMes($semanas[0]['mes'])}}, del <b>{{$semanas[0]['fechaInicio']}}</b> al <b>{{$semanas[0]['fechaFin']}}</b></small>
              </div>
          <hr/>
