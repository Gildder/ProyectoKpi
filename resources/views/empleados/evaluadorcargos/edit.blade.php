...
<div class="panel panel-default">
  ...
  <div class="col-lg-12 breadcrumb">
    <a  href="{{route('empleados.evaluador.index')}}" class="btn btn-primary btn-xs"><span class="fa fa-reply"></span></a>
      ...
      {!!Form::model($evaluador, ['route'=>['empleados.evaluador.update', $evaluador->id], 'method'=>'PUT'])!!}
  ...
  <div class="panel-footer text-right">
      <a  id="cancelar" href="{{route('empleados.evaluador.show', $evaluador->id)}}" class="btn btn-danger" type="reset"><span class="fa fa-times"></span> Cancelar</a>
