<div class="modal fade" aria-hidden="true"  tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" id="modal-loading" style="padding: 0;">
    <div class="col-lg-6  col-md-offset-4" style="position: relative; top: 50%; padding: 0;">
