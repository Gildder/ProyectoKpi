   ...
   <!-- Modal -->
<div class="modal fade modal-slide-in-right" aria-hidden="true" tabindex="-1" role="dialog" id="modal-deleteIndicadorPonderacion-{{$item->id}}">
  <div class="modal-dialog">
    ...
    <div class="modal-delete-content modal-content ">
      ...
      <div class="modal-body modal-delete-body">
           {!!Form::open(['action'=>['Evaluadores\PonderacionController@quitarindicador', $item->id, $ponderacion->id], 'method'=>'GET'])!!}
