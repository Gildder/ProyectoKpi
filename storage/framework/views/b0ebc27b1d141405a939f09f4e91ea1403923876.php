...
<div class="panel panel-default">
  ...
  <div class="col-lg-12 breadcrumb">
    <a  href="<?php echo e(route('indicadores.indicadorcargos.show', $indicador->id)); ?>" class="btn btn-primary btn-xs"><span class="fa fa-reply"></span></a>
      ...
      <?php echo Form::open(['route'=>'indicadores.indicadorcargos.store', 'method'=>'POST']); ?>

        <?php echo Form::hidden('indicador_id', $indicador->id); ?>

        <?php echo Form::hidden('cargo_id', $cargo->id); ?>
