      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Cargo</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
          <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Grupo Localizacion</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>Localizacion</a></li>
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Grupo Departamento</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Departamento</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
