...
<div class="panel panel-default">
  <div class="panel-heading">
      <p class="titulo-panel">Nueva Variable de Indicador</p>
  </div>
  ...
  <div class="col-lg-12 breadcrumb">
    <a  href="{{route('indicadores.variable.index')}}" class="btn btn-primary btn-xs"><span class="fa fa-reply"></span></a>
      ...
      {!!Form::open(['route'=>'indicadores.variable.store', 'method'=>'POST'])!!}
  ...
  <div class="panel-footer text-right">
      <a  id="cancelar" href="{{route('indicadores.variable.index')}}" class="btn btn-danger" type="reset"><span class="fa fa-times"></span> Cancelar</a>
