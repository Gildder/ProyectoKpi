  ...
  <div class="modal-dialog">
    ...
    <div class="modal-delete-content modal-content ">
      ...
      <div class="modal-body modal-delete-body">
               {!!Form::open(['route'=>'tareas.tareaDiaria.store', 'method'=>'POST'])!!}
              ...
              <div class="col-sm-12">
                ...
                <div class="form-group @if ($errors->has('descripcion')) has-error @endif  col-sm-10">
                    ...
                    <input type="text" minlength="5" maxlength="60" name="descripcion" placeholder="Ingresa la descripcion" class="form-control" required>
