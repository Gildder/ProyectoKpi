  ...
  <div class="modal-dialog">
    ...
    <div class="modal-delete-content modal-content ">
      <div class="modal-header modal-delete-header" >
        ...
        Eliminar Grupo Localizacion
      </div>
      <div class="modal-body modal-delete-body">
           <?php echo Form::open(['action'=>['Localizaciones\GrupoLocalizacionController@destroy', $item->id], 'method'=>'DELETE']); ?>

            <div class="modal-body">
              <p>¿Estas seguro que deseas eliminar a <b> <?php echo e($item->nombre); ?></b>?</p>
            </div>
