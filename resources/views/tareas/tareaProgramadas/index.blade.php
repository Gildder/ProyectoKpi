  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb">
      ...
      <div class="text-right col-xs-6 col-sm-6 col-md-6 col-lg-6" >
        ...
        <a  href="{{route('tareas.tareaProgramadas.createnext')}}" @click="mostrarModalLoading()"   class="btn btn-info btn-sm" title="Siguiente Semana"><span class="fa  fa-arrow-right"></span>   <b class="hidden-xs">Prox. Semana</b></a>
      </div>
    </div>
