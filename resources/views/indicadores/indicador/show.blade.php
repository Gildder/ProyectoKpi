    ...
    <div class="tab-content">
      ...
      <div id="datos" class="tab-pane fade in active">
        ...
        <div class="col-sm-12 panel-footer text-right">
          ...
          <a href="javascript:void(0)" class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#modal-delete-{{$indicador->id}}"><span class="fa fa-trash"  title="Eliminar"></span><b > Borrar</b></a>
        </div>
      </div>
    <!-- Fin Indicador -->
