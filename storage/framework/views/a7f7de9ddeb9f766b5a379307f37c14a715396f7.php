  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 breadcrumb">
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <a  href="<?php echo e(route('empleados.empleado.create')); ?>" class="btn btn-primary btn-sm" title="Nuevo"><span class="fa fa-plus">  </span>   <b>Nuevo</b></a>
	...
	<div class="row">
		<div class="col-lg-12">
			<?php echo $__env->make('empleados/empleado/partials/tabla_empleado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		</div>
	</div>
