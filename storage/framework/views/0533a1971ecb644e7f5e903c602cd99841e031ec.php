	...
	<table  id="myTable2" class="table table-striped table-bordered table-condensed table-hover">
		...
		<?php foreach($cargos as $item): ?>
			<tr>
				...
				<td><a href="<?php echo e(route('supervisores.supervisor.show', array($item->id, 0))); ?>" class="btn btn-info btn-xs" class="btn btn-primary btn-xs" title="Agregar Supervisor"><span class="fa fa-user-plus"></span></a></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
