   ...
   <!-- Modal -->
<div class="modal fade modal-slide-in-right" aria-hidden="true" tabindex="-1" role="dialog" id="modal-notaerror-{{$item->id}}">
  <div class="modal-dialog">
    ...
    <div class="modal-delete-content modal-content ">
      <div class="modal-header modal-delete-header" >
        ...
        <b>Quitando Tarea Nro. {{$item->id}}</b>
      </div>
      <div class="modal-body modal-delete-body">
         {!!Form::open(['action'=>['Supervisores\SupervisadosController@quitarErrorTarea',  $empleado_id], 'method'=>'GET'])!!}

          <div class="modal-body">

              <p>La justificacion es necesaria para quitar un error de una tarea.</p>
