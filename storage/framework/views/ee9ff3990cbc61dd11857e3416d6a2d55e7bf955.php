  ...
  <div class="modal-dialog">
    ...
    <div class="modal-delete-content modal-content ">
      ...
      <div class="modal-body modal-delete-body">
           <?php echo Form::open(['action'=>['Indicadores\IndicadorCargoController@quitarcargo', $item->id, $indicador->id], 'method'=>'GET']); ?>

            <div class="modal-body">
              <p>¿Estas seguro que deseas quitar a <b><?php echo e($item->nombre); ?>?</b></p>
